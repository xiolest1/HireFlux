...
- Status: Superseded for the demo workspace by ADR 0004; retained for local fixed-identity mode
- Date: 2026-08-10
...
ADR 0004 later selected signed temporary identities for the deployed demo workspace. A future Cognito implementation remains compatible with the same identity dependency if persistent accounts are added.
