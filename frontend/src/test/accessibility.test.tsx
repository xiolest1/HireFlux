...
import { makeAnalytics, makeApplication, testDashboard } from "./fixtures";
  ...
  server.use(
    http.get(`${API_ORIGIN}/api/v1/analytics`, () =>
      HttpResponse.json({
        ...
        source_performance: [
          {
            ...
            recent: { submitted_count: 3, response_count: 2, response_rate: 2 / 3, interview_count: 1, interview_rate: 1 / 3, offer_count: 0, offer_rate: 0, previous_submitted_count: 3, previous_response_rate: 2 / 3, previous_interview_rate: 1 / 3, response_rate_delta: 0, interview_rate_delta: 0 },
            recent_sample_sufficient: true,
            signal: null,
            guidance: null,
          },
        ],
        ...
        source_summary: { submitted_count: 3, sufficient_for_strategy: false, top_volume: { source: "REFERRAL", submitted_count: 3, application_share: 1, response_rate: 2 / 3, response_rate_delta_vs_overall: 0 }, strongest_response: null, recent_movement: null, concentration: { flagged: true, source: "REFERRAL", application_share: 1, threshold: 0.5, submitted_count: 3 } },
        ...
        progress_narrative: makeAnalytics("90d").progress_narrative,
