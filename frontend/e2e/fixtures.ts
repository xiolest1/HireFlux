...
export const application = {
  ...
  next_step_note: "Waiting for the team to confirm the next round.",
        ...
        actions: [
          {
            ...
            due_date: "2026-08-12",
            priority: "HIGH",
            label: "Check back with the employer",
          ...
          },
          {
            ...
            priority: "LOW",
            label: "Review scheduled interview",
          },
        ],
